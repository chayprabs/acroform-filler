...
3. Complete cross-viewer manual confirmation for A1 in macOS Preview and Chrome PDF viewer.
4. Verify hosted URLs and release artifacts (container publish and hosted API/web checks).
